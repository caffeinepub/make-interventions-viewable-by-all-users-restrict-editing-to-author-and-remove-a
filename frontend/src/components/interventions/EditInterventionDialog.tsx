...
export default function EditInterventionDialog({ intervention, clientId }: EditInterventionDialogProps) {
  const [open, setOpen] = useState(false);
  const [day, setDay] = useState(Number(intervention.date.day).toString());
  const [month, setMonth] = useState(Number(intervention.date.month).toString());
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="flex flex-col gap-1">
                <Label htmlFor="edit-day" className="text-xs text-muted-foreground">Jour</Label>
                <Input
                  id="edit-day"
                  type="number"
                  min="1"
              ...
              <div className="flex flex-col gap-1">
                <Label htmlFor="edit-month" className="text-xs text-muted-foreground">Mois</Label>
                <Input
                  id="edit-month"
                  type="number"
                  min="1"
              ...
              <div className="flex flex-col gap-1">
                <Label htmlFor="edit-year" className="text-xs text-muted-foreground">Année</Label>
                <Input
                  id="edit-year"
                  type="number"
                  min="2000"
