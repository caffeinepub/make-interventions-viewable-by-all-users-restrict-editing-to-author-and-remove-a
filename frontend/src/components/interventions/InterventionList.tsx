...
import { Plus, Trash2, Edit, Eye, AlertTriangle, RefreshCw, Loader2 } from 'lucide-react';
...
export default function InterventionList({ clientId }: InterventionListProps) {
  const { data: interventions, isLoading, error, refetch } = useGetClientInterventions(clientId);
  const { mutate: deleteIntervention, isPending: isDeleting } = useDeleteIntervention();
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  {intervention.canEdit && (
                    <EditInterventionDialog intervention={intervention} clientId={clientId} />
                  )}
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          ...
                          disabled={isDeleting && deletingId === intervention.id}
                        >
